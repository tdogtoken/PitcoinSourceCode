// Copyright (c) 2020-2022 The Pitcoin developers
...
const uint64_t MONEY_SUPPLY                                  = (uint64_t)(-1); // If you use 12 Decimal poin on line 36, pitcoin total supply 18,446,744 coins
